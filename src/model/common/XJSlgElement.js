...
(function() {
	 ...
	 * @constructor
	 */
	var XJSlgElement = jslgEngine.extend(
	 ...
	 * @property
	 * @type String
	 * @memberOf jslgEngine.model.common.XJSlgElement#
	 **/
	p.className = 'Element';
	 ...
	 * <li>{jslgEngine.model.common.XJSlgElementFinder} finder</li>
	 * <li>{String} filter</li>
	 * </ul>
	 */
	 ...
	 * @function
	 * @memberOf jslgEngine.model.common.XJSlgElement#
	 * @param {jslgEngine.model.common.XJSlgElementBase} element キー書き換え元要素
	 */
	...
	p.getIconInfo = function(data, options) {
		...
		// 第３引数 3D
		// geometry, materials
		var modelArgugemnts = graphics[2];
		var modelKey = modelArgugemnts[0];	
