...
(function() {
     ...
     * </ul>
	 * @class
	 * @name ActionJSlgCustomize
	 * @memberOf jslgEngine.model.action
	 * @constructor
	 */
	var ActionJSlgCustomize = jslgEngine.extend(
	 ...
	 *
	 */
	var p = ActionJSlgCustomize.prototype;
	 ...
	 * @property
	 * @type String
	 * @memberOf jslgEngine.model.action.ActionJSlgCustomize#
	 **/
	p.className = 'ActionJSlgCustomize';
	...
	o.ActionJSlgCustomize = ActionJSlgCustomize;
}());
