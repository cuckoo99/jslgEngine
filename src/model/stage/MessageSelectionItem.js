...
(function() {
	 ...
	 * </p>
	 * @class
	 * @name MessageSelectionItem
	 * @memberOf jslgEngine.model.stage
	 * @constructor
	 */
	var MessageSelectionItem = jslgEngine.extend(
	 ...
	 *
	 */
	var p = MessageSelectionItem.prototype;
	 ...
	 * @property
	 * @type String
	 * @memberOf jslgEngine.model.stage.MessageSelectionItem#
	 **/
	p.className = 'MessageSelectionItem';
	 ...
	 * @memberOf jslgEngine.model.stage.MessageSelectionItem#
	 **/
	p._keyCode = 'MessageSelectionItem';
	...
	p.getSelectionItemLength = function(data, options) {
		...
		for(var i = 0, len = pChildren.length; i < len; i++) {
			if(pChildren[i].className === 'MessageSelectionItem') {
				count++;
			}
		}
		return count;
	...
	o.MessageSelectionItem = MessageSelectionItem;
}());
